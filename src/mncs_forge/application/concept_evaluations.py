...
class ConceptEvaluationService:
    ...
    def _summary(record: ForgeRecord) -> JsonObject:
        ...
        summary: JsonObject = {
            ...
            "concept_experiment_id": record["concept_experiment_id"],
            ...
            "execution_identities": record["execution_identities"],
            "verifier_identity": record["verifier_identity"],
            "obligation": record["obligation"],
            "evidence_identities": record["evidence_identities"],
            "status": record["status"],
            "unresolved_obligations": record["unresolved_obligations"],
            "generator_certified": record["generator_certified"],
